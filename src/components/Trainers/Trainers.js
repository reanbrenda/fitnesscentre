...
const Trainers = () => {
    return (
        <section className="trainers" css={styles}>
            <Heading title="OUR TRAINERS" info="We have the best trainers who are very qualified." />
            <Container>
                <TrainerCard trainerImg={Trainer3} trainerName="Jessica MUKAMI" trainerType="Woman Trainer" />
                <TrainerCard trainerImg={Trainer1} trainerName="Amit KARANI" trainerType="Men Trainer" />
                <TrainerCard trainerImg={Trainer2} trainerName="Paulo RONO" trainerType="Men Trainer" />
            </Container>
        </section>
    )
}
